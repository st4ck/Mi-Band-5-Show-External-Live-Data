...
import com.cyberdynamic.stocks_player.MainActivity;
...
final public class PlayerService extends Service {
    ...
    public static final MediaMetadataCompat.Builder metadataBuilder = new MediaMetadataCompat.Builder();
        ...
        public void onPlay() {
            ...
            if (firsttime) {
                ...
                handler.postDelayed(new Runnable() {
                    public void run() {
                        new JsonTask().execute("https://s3.amazonaws.com/oilprice.com/widgets/oilprices/45/last.json");
